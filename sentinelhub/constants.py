...
class DataSource(Enum, metaclass=DataSourceMeta):
    ...
    @classmethod
    def from_api_identifier(cls, value):
        # TODO: rethink this
        # TODO: merge with develop and add CUSTOM
        return {
            'S2L1C': cls.SENTINEL2_L1C,
            'S2L2A': cls.SENTINEL2_L2A,
            'L8L1C': cls.LANDSAT8_L1C,
            'DEM': cls.DEM,
            'MODIS': cls.MODIS
        }[value]
...
class MimeType(Enum):
    # TODO: improve parsing in this class
    ...
    GML = 'gml'
    TXT = 'txt'
    TAR = 'tar'  # TODO: resolve application/tar vs application/x-tar
    RAW = 'raw'
    SAFE = 'safe'
    ...
    def get_string(self):
        ...
        if self is MimeType.TAR:
            return 'application/x-tar'  # TODO: more correct would be application/x-tar but SH service wants application/tar
