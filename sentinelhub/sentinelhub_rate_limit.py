...
class SentinelHubRateLimit:
    ...
    def __init__(self, session, *, status_refresh_period=60):
        ...
        :type session: sentinelhub.SentinelHubSession
    ...
    def _initialize_policy_buckets(self):
        ...
        for policy_payload in user_policies['data']:
            ...
            policy_type = policy_payload['type']['name']
    ...
    def register_next(self):
        ...
        # log(f'stats: process_num={self.expected_process_num}, {self.expected_cost_per_request}, {self.requests_in_process}, '
        #     f'{self.last_status_update_time}, {elapsed_time}')
        ...
        # log(f'wait: {max_wait_time}, {self.requests_in_process}')
    ...
    def update(self, headers):
        ...
        # log(f'Update {self.expected_process_num}, {self.expected_cost_per_request}, {self.requests_in_process}, '
        #     f'{is_rate_limited}, {self.requests_in_process}, {elapsed_time}')
        ...
        # log(f' rps={requests_per_second}, cps={cost_per_second}')
        # log(f'End: {self.expected_process_num}, {self.expected_cost_per_request}, {self.requests_in_process}')
    ...
    def _update_expected_process_num(self, requests_done, is_rate_limited=False):
        ...
        # log(f'max={max_process_num}, min={min_process_num}')
    ...
    def _update_expected_cost_per_request(self, cost_per_request, is_rate_limited=False):
        ...
        # log(f'ecpr={self.expected_cost_per_request}, ncpr={cost_per_request}, vd={value_difference}')
