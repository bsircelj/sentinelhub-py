...
class AwsDownloadClient(DownloadClient):
    ...
    def _get_s3_client(self):
        ...
        try:
            s3_client = boto3.Session().client('s3', **key_args) # TODO: check if it would be better to just take the global one
    ...
    def _do_download(request, s3_client):
        ...
        # TODO: include https://github.com/sentinel-hub/sentinelhub-py/blob/feat/aws-speedup/sentinelhub/download.py#L310
