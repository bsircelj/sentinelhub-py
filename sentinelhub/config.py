...
class SHConfig:
    ...
    ``./config.json`` file:
        ...
        - `sh_base_url`: Base url for Sentinel Hub's services.
    ...
    def has_eocloud_url(self):
        ...
        :rtype: bool
        """
        return 'eocloud' in self._instance.sh_base_url

    def get_sh_oauth_url(self):
        """ Provides URL for Sentinel Hub authentification endpoint

        :return: An URL endpoint
        :rtype: str
        """
        return '{}/oauth/token'.format(self._instance.sh_base_url)
    ...
    def get_sh_processing_api_url(self):
        ...
        :rtype: str
        """
        return '{}/api/v1/process'.format(self._instance.sh_base_url)
    ...
    def get_sh_ogc_url(self):
        ...
        return '{}/{}'.format(self._instance.sh_base_url, ogc_enpoint)
    ...
    def get_sh_rate_limit_url(self):
        ...
        :rtype: str
        """
        return '{}/aux/ratelimit'.format(self._instance.sh_base_url)
